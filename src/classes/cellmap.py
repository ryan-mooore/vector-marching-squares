"""Helper class connecting cells by their edges."""
...
class CellMap:
    ...
    def __init__(self, heightmap):
        ...
        self.width = len(heightmap[0]) - 1
        self.height = len(heightmap) - 1
        ...
        for z in range(self.height):
            ...
            for x in range(self.width):
                ...
                if x == 0:
                    ...
                    self._link_edge(cell, cell_row[x - 1].edges[Edge.name.RIGHT.value])
                # top
                if z == 0:
...
class Edge:
    __slots__ = ["corner1", "corner2", "cells", "axis_pos", "type", "isolines", "axis"]
    ...
    def min_corner(self) -> int:
        return min(self.corner1, self.corner2)

    def max_corner(self) -> int:
        return max(self.corner1, self.corner2)
